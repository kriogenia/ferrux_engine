...
pub fn vector_dot_matrix(vector: Vector, matrix: &Matrix4) -> Vector {
	let x = vector.0 * matrix[0][0] + vector.1 * matrix[1][0] + vector.2 * matrix[2][0] + matrix[3][0];
	let y = vector.0 * matrix[0][1] + vector.1 * matrix[1][1] + vector.2 * matrix[2][1] + matrix[3][1];
	let z = vector.0 * matrix[0][2] + vector.1 * matrix[1][2] + vector.2 * matrix[2][2] + matrix[3][2];
